...
public class AstraDB {
     ...
     *      json vector store
     */
    public AstraCollection createCollection(String name) {
        return new AstraCollection(nsClient.createCollection(name));
    }
     ...
     *      json vector store
     */
    public AstraCollection createCollection(String name, int vectorDimension) {
        return new AstraCollection(nsClient.createCollection(name, vectorDimension));
    }
     ...
     *      json vector store
     */
    public AstraCollection createCollection(String name, int vectorDimension, SimilarityMetric metric) {
        return new AstraCollection(nsClient.createCollection(CollectionDefinition
                .builder()
                .name(name)
     ...
     *      json vector store
     */
    public AstraCollection createCollection(CollectionDefinition def) {
        return new AstraCollection(nsClient.createCollection(def));
    }
     ...
     *      storeName client
     */
    public AstraCollection getCollection(@NonNull  String storeName) {
        return new AstraCollection(nsClient.collection(storeName));
    }
