...
public class AstraDatabaseTestSuiteIT {
    ...
    static AstraCollection collectionDeny;
    static AstraCollection collectionAllow;
    static AstraCollection collectionVector;
