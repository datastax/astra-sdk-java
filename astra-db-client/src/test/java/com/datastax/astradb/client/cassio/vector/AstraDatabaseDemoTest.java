 ...
 */
public class AstraDatabaseDemoTest {
    ...
    public void shouldDoCollection() {
        ...
        // Create Database
        UUID uuid = astraDBAdmin.createDatabase(AstraDatabaseTestSuiteIT.TEST_DBNAME);

        // Select Database / Namespace
        NamespaceClient db = astraDBAdmin
                .getDataApiClient(AstraDatabaseTestSuiteIT.TEST_DBNAME)
