...
public class BreakAstraTest {
    ...
    static AstraCollection collectionSimple;
    ...
    public void testQueryBust() {
        ...
        List<Document<AstraDatabaseTestSuiteIT.Product>> documents = new ArrayList<>();
        ...
        for (int i = 0; i < nbDocs; i++) {
            documents.add(new Document<AstraDatabaseTestSuiteIT.Product>()
                    .id(String.valueOf(i))
                    .vector(fakeEmbeddings)
                    .data(new AstraDatabaseTestSuiteIT.Product("Desc " + i, i * 1.0d)));
        }
