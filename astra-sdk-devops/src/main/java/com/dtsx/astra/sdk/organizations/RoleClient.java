package com.dtsx.astra.sdk.organizations;
...
import com.dtsx.astra.sdk.organizations.domain.RoleDefinition;
...
public class RoleClient {
    ...
    public void update(RoleDefinition cr) {
        http.PUT(getEndpointRole(), orgClient.bearerAuthToken, JsonUtils.marshall(cr));
    }
