...
import com.datastax.astra.devops.db.domain.DatabaseCreationBuilder;
...
public class TestUtils {
    ...
    public static String setupDatabase(String token, AstraEnvironment env, String dbName, String keyspace, boolean vector) {
        AstraDBDevopsClient devopsDbCli = new AstraDBDevopsClient(getAstraToken(), env);
     ...
     *      database name
     */
    public static void terminateDatabaseByName(AstraDBDevopsClient devopsDbCli, String dbName) {
        DbOpsClient dbc = new AstraDBDevopsClient(devopsDbCli.getToken()).databaseByName(dbName);
        if(dbc.exist()) {
            dbc.delete();
