...
import com.datastax.astra.devops.org.domain.InviteUserRequest;
...
import com.datastax.astra.devops.org.exception.UserNotFoundException;
...
import com.datastax.astra.devops.utils.IdUtils;
...
public class UsersClient extends AbstractApiClient {
    ...
    public void invite(String email, String... roles) {
        ...
        AstraDevopsClient devopsApiClient = new AstraDevopsClient(token);
