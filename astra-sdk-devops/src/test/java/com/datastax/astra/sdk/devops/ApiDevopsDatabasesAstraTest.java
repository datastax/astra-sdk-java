...
import org.datastax.astra.sdk.domain.CloudProviderType;
import org.datastax.astra.sdk.domain.DatabaseRegion;
import org.datastax.astra.sdk.domain.Organization;
...
public class ApiDevopsDatabasesAstraTest extends AbstractDevopsApiTest {
    ...
    public void should_connect_with_AstraClient() throws InterruptedException {
        Assertions.assertNotNull(new OrganizationsClient(getToken())
                    .regions()
    ...
    public void should_connect_with_OrganizationsClient() {
        ...
        // When
        OrganizationsClient cli = new OrganizationsClient(getToken());
        // Then
