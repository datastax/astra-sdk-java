...
public class DatabasesClientTest extends AbstractDevopsApiTest {
    ...
    public void failInitializationsWithInvalidParamsTest() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new AstraDBDevopsClient(""));
        Assertions.assertThrows(IllegalArgumentException.class, () -> new AstraDBDevopsClient(null));
    }
