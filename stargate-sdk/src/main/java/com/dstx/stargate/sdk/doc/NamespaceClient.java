    ...
    public Optional<Namespace> find() {
        ...
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    ...
                    .uri(URI.create(docClient.getEndPointApiDocument() + PATH_SCHEMA + ApiDocumentClient.PATH_SCHEMA_NAMESPACES + "/" + namespace ))
                    .GET().build();
    ...
    public void create(DataCenter... datacenters) {
        ...
        try {
            HttpRequest request = HttpRequest.newBuilder()
                    ...
                    .header(HEADER_CONTENT_TYPE, CONTENT_TYPE_JSON)
                    .header(HEADER_CASSANDRA, docClient.getToken())
                    .uri(URI.create(docClient.getEndPointApiDocument() + PATH_SCHEMA + ApiDocumentClient.PATH_SCHEMA_NAMESPACES))
    ...
    public Stream<String> collectionNames() {
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    ...
                    .header(HEADER_CONTENT_TYPE, CONTENT_TYPE_JSON)
                    .header(HEADER_CASSANDRA, docClient.getToken())
                    .uri(URI.create(docClient.getEndPointApiDocument() + PATH_NAMESPACES 
