...
public class LoadBalancingResource < RSC > implements Comparable < LoadBalancingResource < RSC > > {
    ...
    *      current resource
    */
    public LoadBalancingResource(String id, double defaultWeight, RSC resource) {
        this.id            = id;
    ...
    public final String toString() {
        ...
        if (isAvailable()) {
            strBuild.append(" current weight " + Double.valueOf(this.currentWeight).intValue() + "% " + resource.toString());
        } else {
            strBuild.append(" ---");
        }
