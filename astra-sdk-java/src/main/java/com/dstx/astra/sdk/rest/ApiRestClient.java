...
import static com.dstx.astra.sdk.utils.Assert.hasLength;
...
import com.dstx.astra.sdk.utils.ApiSupport;
import com.dstx.astra.sdk.utils.JsonUtils;
...
public class ApiRestClient extends ApiSupport {
     ...
     */
    public ApiRestClient(String astraDatabaseId, String astraDatabaseRegion, String username, String password) {
