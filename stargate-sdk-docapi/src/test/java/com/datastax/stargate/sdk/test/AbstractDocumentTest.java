...
import com.datastax.stargate.sdk.doc.*;
...
public abstract class AbstractDocumentTest implements ApiDocumentTest {
    ...
    public void l_testInvalidDoc() {
        ...
        DocumentClient dc = apiDocumentClient.namespace("n").collection("c")
                .document("??a=&invalid??");
