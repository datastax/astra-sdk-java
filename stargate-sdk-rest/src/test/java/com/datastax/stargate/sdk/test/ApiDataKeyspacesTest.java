...
public abstract class ApiDataKeyspacesTest implements ApiDataTest {
    ...
    /** Tested Store. */
    protected static ApiDataClient stargateClient = new ApiDataClient();
    ...
    public void createKeyspaceWithSimpleStrategyTest() throws InterruptedException {
        // Given
        KeyspaceClient ksTemp = stargateClient.keyspace(TEST_KEYSPACE);
    ...
    public void listKeyspacesTest() {
        Assertions.assertTrue(stargateClient
                .keyspaceNames().collect(Collectors.toSet())
                .contains(TEST_KEYSPACE));
        
        // Keyspace populated
        Map<String, Keyspace> nsList = stargateClient
    ...
    public void e_should_get_keyspace_by_name() {
        // Given
        Assertions.assertTrue(stargateClient.keyspace(TEST_KEYSPACE).exist());
        // When
        Optional<Keyspace> nsTest = stargateClient.keyspace(TEST_KEYSPACE).find();
        // Then
        ...
        // Given
        Assertions.assertFalse(stargateClient.keyspace("invalid").exist());
        Assertions.assertFalse(stargateClient.keyspace("invalid").find().isPresent());
    }
    ...
    public void f_should_delete_Keyspace() {
        KeyspaceClient javaBis = stargateClient
